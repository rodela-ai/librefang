...
> The Sidecar adapter enables external processes written in any language to act as channel adapters via JSON-RPC over stdin/stdout. Telegram / ntfy / Gotify / Mastodon / Bluesky / Reddit / Twitch / Rocket.Chat / Nextcloud Talk / Discord / Slack / Webex / LINE / Zulip / Mattermost / Signal / QQ / Matrix / WeCom / Feishu / Email / DingTalk ship as first-party Python sidecars in `librefang-sdk`.
