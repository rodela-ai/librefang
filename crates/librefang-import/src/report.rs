...
impl MigrationReport {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        out.push_str("3. Set any remaining API keys referenced in `~/.librefang/config.toml`\n");
        out.push_str("4. Start the daemon: `librefang start`\n");
        out.push_str("5. Test your agents: `librefang agent list`\n");
    ...
    pub fn print_summary(&self) {
        ...
        if !self.dry_run {
            println!("\n  Next steps:");
            println!("    librefang start");
            println!("    librefang agent list");
        }
    }
}
    ...
    fn test_report_with_items() {
        let report = MigrationReport {
            ...
            imported: vec![MigrateItem {
                ...
                destination: "~/.librefang/agents/coder/agent.toml".to_string(),
            }],
