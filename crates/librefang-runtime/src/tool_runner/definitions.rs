...
mod tool_name {
    ...
    pub const AGENT_FIND: &str = "agent_find";
    pub const TASK_POST: &str = "task_post";
    ...
    pub const SKILL_READ_FILE: &str = "skill_read_file";
    ...
    pub const IMAGE_ANALYZE: &str = "image_analyze";
    pub const LOCATION_GET: &str = "location_get";
    ...
    pub const BROWSER_READ_PAGE: &str = "browser_read_page";
    ...
    pub const BROWSER_RUN_JS: &str = "browser_run_js";
    pub const BROWSER_BACK: &str = "browser_back";
    pub const MEDIA_DESCRIBE: &str = "media_describe";
    pub const MEDIA_TRANSCRIBE: &str = "media_transcribe";
    ...
    pub const MUSIC_GENERATE: &str = "music_generate";
    ...
    pub const HAND_DEACTIVATE: &str = "hand_deactivate";
    pub const A2A_DISCOVER: &str = "a2a_discover";
    pub const A2A_SEND: &str = "a2a_send";
    pub const TEXT_TO_SPEECH: &str = "text_to_speech";
    pub const SPEECH_TO_TEXT: &str = "speech_to_text";
    pub const DOCKER_EXEC: &str = "docker_exec";
    ...
    pub const WORKFLOW_DESCRIBE: &str = "workflow_describe";
    ...
    pub const SKILL_EVOLVE_CREATE: &str = "skill_evolve_create";
    pub const SKILL_EVOLVE_UPDATE: &str = "skill_evolve_update";
    pub const SKILL_EVOLVE_PATCH: &str = "skill_evolve_patch";
    pub const SKILL_EVOLVE_DELETE: &str = "skill_evolve_delete";
    pub const SKILL_EVOLVE_ROLLBACK: &str = "skill_evolve_rollback";
    pub const SKILL_EVOLVE_WRITE_FILE: &str = "skill_evolve_write_file";
    pub const SKILL_EVOLVE_REMOVE_FILE: &str = "skill_evolve_remove_file";
...
pub const ALWAYS_NATIVE_TOOLS: &[&str] = &[
    ...
    tool_name::SKILL_READ_FILE,
    tool_name::SKILL_EVOLVE_CREATE,
    tool_name::SKILL_EVOLVE_UPDATE,
    tool_name::SKILL_EVOLVE_PATCH,
    tool_name::SKILL_EVOLVE_DELETE,
    tool_name::SKILL_EVOLVE_ROLLBACK,
    tool_name::SKILL_EVOLVE_WRITE_FILE,
    tool_name::SKILL_EVOLVE_REMOVE_FILE,
];
...
pub fn select_native_tools(all: &[ToolDefinition]) -> Vec<ToolDefinition> {
    static WANT: OnceLock<std::collections::HashSet<&'static str>> = OnceLock::new();
    let want = WANT.get_or_init(|| ALWAYS_NATIVE_TOOLS.iter().copied().collect());
    let found: Vec<_> = all
        .iter()
...
pub fn builtin_tool_definitions() -> Vec<ToolDefinition> {
    static DEFNS: OnceLock<Vec<ToolDefinition>> = OnceLock::new();
    DEFNS.get_or_init(|| {
        let mut tools = Vec::new();

        tools.extend(vec![
            ToolDefinition {
                name: tool_name::FILE_READ.to_string(),
            ...
            ToolDefinition {
                name: tool_name::FILE_WRITE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::FILE_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::APPLY_PATCH.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WEB_FETCH.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WEB_FETCH_TO_FILE.to_string(),
...
use instead of web_fetch + file_write (which round-trips the entire body through the model)."
            ...
            ToolDefinition {
                name: tool_name::SHELL_EXEC.to_string(),
            ...
            ToolDefinition {
                name: tool_name::NOTIFY_OWNER.to_string(),
            ...
            ToolDefinition {
                name: tool_name::AGENT_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::AGENT_KILL.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WIKI_GET.to_string(),
                description:
            ...
            ToolDefinition {
                name: tool_name::WIKI_SEARCH.to_string(),
                description:
            ...
            ToolDefinition {
                name: tool_name::WIKI_WRITE.to_string(),
                description:
            ...
            ToolDefinition {
                name: tool_name::AGENT_FIND.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TASK_POST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TASK_CLAIM.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TASK_COMPLETE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TASK_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TASK_STATUS.to_string(),
            ...
            ToolDefinition {
                name: tool_name::EVENT_PUBLISH.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_READ_FILE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SCHEDULE_CREATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SCHEDULE_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::KNOWLEDGE_ADD_ENTITY.to_string(),
            ...
            ToolDefinition {
                name: tool_name::KNOWLEDGE_ADD_RELATION.to_string(),
            ...
            ToolDefinition {
                name: tool_name::KNOWLEDGE_QUERY.to_string(),
            ...
            ToolDefinition {
                name: tool_name::IMAGE_ANALYZE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::LOCATION_GET.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_NAVIGATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_TYPE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_SCREENSHOT.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_READ_PAGE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_CLOSE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_SCROLL.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_WAIT.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_RUN_JS.to_string(),
            ...
            ToolDefinition {
                name: tool_name::BROWSER_BACK.to_string(),
        ...
        tools.extend(vec![
            ToolDefinition {
                name: tool_name::MEDIA_DESCRIBE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::IMAGE_GENERATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::VIDEO_GENERATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::VIDEO_STATUS.to_string(),
            ...
            ToolDefinition {
                name: tool_name::MUSIC_GENERATE.to_string(),
        ...
        tools.extend(vec![
            ToolDefinition {
                name: tool_name::CRON_CREATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::CRON_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::CHANNEL_SEND.to_string(),
            ...
            ToolDefinition {
                name: tool_name::HAND_ACTIVATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::HAND_STATUS.to_string(),
            ...
            ToolDefinition {
                name: tool_name::HAND_DEACTIVATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::A2A_DISCOVER.to_string(),
            ...
            ToolDefinition {
                name: tool_name::A2A_SEND.to_string(),
        ...
        tools.extend(vec![
            ToolDefinition {
                name: tool_name::TEXT_TO_SPEECH.to_string(),
        ...
        tools.extend(vec![
            ToolDefinition {
                name: tool_name::DOCKER_EXEC.to_string(),
            ...
            ToolDefinition {
                name: tool_name::PROCESS_POLL.to_string(),
            ...
            ToolDefinition {
                name: tool_name::PROCESS_WRITE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::PROCESS_KILL.to_string(),
            ...
            ToolDefinition {
                name: tool_name::PROCESS_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::GOAL_UPDATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_RUN.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_LIST.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_DESCRIBE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_STATUS.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_START.to_string(),
            ...
            ToolDefinition {
                name: tool_name::WORKFLOW_CANCEL.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SYSTEM_TIME.to_string(),
            ...
            ToolDefinition {
                name: tool_name::CANVAS_PRESENT.to_string(),
            ...
            ToolDefinition {
                name: tool_name::READ_ARTIFACT.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_CREATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_UPDATE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_PATCH.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_DELETE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_ROLLBACK.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_WRITE_FILE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::SKILL_EVOLVE_REMOVE_FILE.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TOOL_LOAD.to_string(),
            ...
            ToolDefinition {
                name: tool_name::TOOL_SEARCH.to_string(),
